...
2. Use the real traffic signs to get a template for the detection method.

3. Use a loop to go through each frame and look for the traffic signs

4. Create a function to find and verify the signs using the template.
